...
export default class ForecastFilterComponent extends Component {
  ...
  get results() {
    ...
    return fetch(url).then(data => {
      ...
      this.filtered = forecasts;
      //this.store.createRecord('forecast',data);   
